...
The complete source code used for data preprocessing, model estimation, MCMC diagnostics, and figure generation is available at:

\url{https://github.com/giolagioia/Bayes-Anomaly-Detection}
...
Watsky, A. \href{https://www.kaggle.com/datasets/apoorvwatsky/bank-transaction-data}{Extracted bank account statements of various bank accounts}.
\end{document}
