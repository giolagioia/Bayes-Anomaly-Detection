...
Final 95\% credible interval lower bound & 0.048960 \\
Final 95\% credible interval upper bound & 0.051063 \\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{../plots/03_sequential_bayesian_learning.png}
...
Thus, the F1-optimized threshold gives a better balance between precision and recall than the fixed threshold $0.5$. AUC and log loss remain unchanged because they evaluate predicted probabilities, not the final binary classification.
...
For the Bayesian model with Cauchy$(0,2.5)$ prior, the posterior predictive probabilities have mean $0.050558$ and median $0.000387$. Their 2.5\% and 97.5\% quantiles are $0.000006$ and $0.349947$, respectively. The average width of the 95\% credible interval is $0.005020$, with median width $0.000133$.
