...
\begin{frame}{Anomaly Rate Over Time}
  \begin{columns}
    \begin{column}{0.38\textwidth}
      \begin{itemize}
        \item Final posterior mean: 0.050007.
        \item Final 95\% credible interval:
        \[
        [0.048960,\ 0.051063]
        \]
...
\begin{frame}{MCMC Diagnostics}
  ...
  \begin{itemize}
    \item $\hat{R}$ close to 1 indicates convergence.
...
\begin{frame}{Bayesian Logistic Regression Results}
...
\begin{frame}{Main Takeaways}
  ...
  \begin{itemize}
    ...
    \item Conjugacy gives an analytical solution for the Beta-Binomial model.
