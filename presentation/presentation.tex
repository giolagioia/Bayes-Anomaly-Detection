...
\title[Bayesian Anomaly Detection]{Bayesian Anomaly Detection}
...
\begin{frame}{Anomaly Rate Over Time}
  \begin{columns}
    \begin{column}{0.38\textwidth}
      \begin{itemize}
        \item Final posterior mean: $\mathbb{E}[\pi \mid Y] = 0.050007$.
...
\begin{frame}{Why MCMC?}
  ...
  {\int p(\bm{\tilde{\beta}})p(Y\mid X,\bm{\tilde{\beta}})d\bm{\tilde{\beta}}}
  \]
\end{frame}
